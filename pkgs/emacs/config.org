...
- [[#base-settings][Base Settings]]
  ...
  - [[#evil-mode][Evil Mode]]
  - [[#keybinds][Keybinds]]
  - [[#globl---window][Globl - window]]
  - [[#globl---git][globl - git]]
  - [[#globl---org][globl - org]]
  - [[#globl---projectile][globl - projectile]]
  - [[#globl---toggle][globl - toggle]]
- [[#programs][Programs]]
  - [[#dired][Dired]]
  - [[#treemacs][Treemacs]]
  - [[#vterm][Vterm]]
...
#+end_src
** Java
+ I use java-lsp since it has more out-of-the-box features
+ TLDR, make sure eglot does not touch java, and have lsp-mode
  manage java
#+begin_src emacs-lisp
